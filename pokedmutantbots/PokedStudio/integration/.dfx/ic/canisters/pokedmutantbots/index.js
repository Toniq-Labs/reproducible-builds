...
import { idlFactory } from './pokedmutantbots.did.js';
export { idlFactory } from './pokedmutantbots.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.POKEDMUTANTBOTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pokedmutantbots.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pokedmutantbots canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pokedmutantbots.did.js")._SERVICE>}
 */
export const pokedmutantbots = createActor(canisterId);
