export const idlFactory = ({ IDL }) => {
  ...
  const MoonWalker = IDL.Service({
    ...
    'getAssets' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(AssetHandle, Asset))],
        ['query'],
      ),
    'getMinter' : IDL.Func([], [IDL.Principal], ['query']),
    'getNextSubAccount' : IDL.Func([], [IDL.Nat], ['query']),
    'getRegistry' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(TokenIndex, AccountIdentifier__1))],
        ['query'],
      ),
    'getThumbs' : IDL.Func([], [IDL.Vec(AssetHandle)], ['query']),
    'getTokens' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(TokenIndex, Metadata))],
        ['query'],
      ),
    'get_royalty_address' : IDL.Func([], [IDL.Text], ['query']),
    ...
    'transferBulk' : IDL.Func([BulkTransferRequest], [TransferResponse], []),
  });
  return MoonWalker;
};
