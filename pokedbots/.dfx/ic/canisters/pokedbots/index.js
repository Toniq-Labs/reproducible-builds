...
import { idlFactory } from './pokedbots.did.js';
export { idlFactory } from './pokedbots.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.POKEDBOTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pokedbots.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pokedbots canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pokedbots.did.js")._SERVICE>}
 */
export const pokedbots = createActor(canisterId);
