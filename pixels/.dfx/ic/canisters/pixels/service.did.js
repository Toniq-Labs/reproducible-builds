export const idlFactory = ({ IDL }) => {
  ...
  const Result_6 = IDL.Variant({ 'ok' : IDL.Text, 'err' : CommonError });
  ...
  const PixelCollection = IDL.Service({
    'acceptCycles' : IDL.Func([], [], []),
    'addAsset' : IDL.Func([Asset], [IDL.Nat], []),
    'add_license' : IDL.Func([IDL.Text, IDL.Text], [], ['oneway']),
    ...
    'init' : IDL.Func([IDL.Text], [Result_3], []),
    'isHeartbeatRunning' : IDL.Func([], [IDL.Bool], ['query']),
    'lastbeat' : IDL.Func([], [IDL.Int], ['query']),
    'license' : IDL.Func([TokenIdentifier__1], [Result_6], ['query']),
    ...
    'map_license' : IDL.Func([TokenIndex, IDL.Text], [], ['oneway']),
