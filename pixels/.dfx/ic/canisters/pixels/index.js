...
import { idlFactory } from './pixels.did.js';
export { idlFactory } from './pixels.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PIXELS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pixels.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pixels canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pixels.did.js")._SERVICE>}
 */
export const pixels = createActor(canisterId);
