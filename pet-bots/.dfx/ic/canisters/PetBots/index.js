...
import { idlFactory } from './PetBots.did.js';
export { idlFactory } from './PetBots.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PETBOTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./PetBots.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the PetBots canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./PetBots.did.js")._SERVICE>}
 */
export const PetBots = createActor(canisterId);
